package in.expedite.wiki.resource;
...
public class PageController {
	...
	public String addPage(@RequestParam String title, @RequestAttribute(required = false) String username, Model model,
	...
	public String editPage(@ModelAttribute Page page, @RequestAttribute(required = false) String username, Model model,
			HttpServletRequest request) {
		model.addAttribute("contextPath", request.getContextPath());
		page = pageService.savePage(page, username);
		String content = page.getContent();
	...
	public String search(@RequestParam String searchtext, Model model, HttpServletRequest request) {
		...
		model.addAttribute("sidebar", getSideBar());
		model.addAttribute("contextPath", request.getContextPath());
		List<Page> page = pageService.searchPage(searchtext);
