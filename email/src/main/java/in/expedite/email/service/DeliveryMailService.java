...
import in.expedite.email.DAO.ConfigurationDAO;
...
public class DeliveryMailService {
	...
	@Async
	public void sendMailForApprovalRequest(
			String reqId,
			String project,
			String team,
			String application,
		...
		String text=FreeMarkerTemplateUtils.processTemplateIntoString(freeMakerConfig.getTemplate("velocity/deliveryApprovalRequest.html"),model);
